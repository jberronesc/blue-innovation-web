...
import AuthSlice from "../../reduxt-toolkit/slices/authSlice"
...
function NavLinks2() {
  ...
  const { menus, permissions } = useSelector((store: AppStore) => store.auth)
          ...
          <li>
            <button
              ...
              className={clsx(
                ...
                {
                  "bg-sky-100 text-blue-600": menu.isColored,
                }
              )}
              ...
              onClick={() =>
                dispatch(
                  AuthSlice.actions.openMenu({ menuId: menu.id, pathname })
                )
              }
            >
              <svg
                  ...
                  <>
                    <li>
                      <Link
                        ...
                        onClick={() =>
                          dispatch(
                            ConfigSystemSlice.actions.updateLoadingSide(true)
                          )
                        }
                      >
                        <p className="hidden md:block">{module.name}</p>
                      </Link>
                    </li>
                  </>
                )
...
export function SideNav({ exit }: { exit: () => {} }) {
  const pathname = usePathname()
  const dispatch = useDispatch()
            ...
            <li>
              <Link
                ...
                className={clsx(
                  ...
                  {
                    "bg-sky-100 text-blue-600": pathname == "/client/dashboard",
                  }
                )}
                onClick={goDahsboard}
              >
