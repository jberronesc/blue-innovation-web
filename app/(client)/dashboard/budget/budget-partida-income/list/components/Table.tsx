...
import { BudgetPartidaIncomeListEntity } from "@budget/budget-partida-income/domain/interfaces/BudgetPartidaIncomeListEntity"
import { useSelector } from "react-redux"
import { AppStore } from "@rdtkl/store"

const constant = BudgetPartidaIncomeConst

export default function BudgetPartidaIncomeTable({
  registers,
}: {
  registers: BudgetPartidaIncomeListEntity[]
}) {
        ...
        <TNBR key={register.id}>
          ...
          <TNBC>
            <div className="flex justify-center gap-3">
              {permissions.changeBudgetpartidaincome && (
                <ButtonLinkRoundedToGo
                  href={constant.editUrl({
                    budgetPartidaIncomeId: register.id,
                  })}
